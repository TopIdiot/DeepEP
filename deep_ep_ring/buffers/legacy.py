...
# noinspection PyUnresolvedReferences
from deep_ep_ring._C import Config, EventHandle
...
class Buffer:
    ...
    def get_dispatch_layout(self, topk_idx: torch.Tensor, num_experts: int,
        ...
        Arguments:
            topk_idx: `[num_tokens, num_topk]`, dtype must be `deep_ep_ring.topk_idx_t` (typically `torch.int64`), the expert
    ...
    def dispatch(self, x: Union[torch.Tensor, Tuple[torch.Tensor, torch.Tensor]],
        ...
        Arguments:
            ...
            is_token_in_rank: `[num_tokens, num_ranks]` with `torch.bool`, whether a token be sent to a rank.
            num_tokens_per_expert: `[num_experts]` with `torch.int`, the number of tokens to be sent to each expert.
            topk_idx: `[num_tokens, num_topk]` with `deep_ep_ring.topk_idx_t` (typically `torch.int64`), the expert indices
    ...
    def low_latency_dispatch(self, x: torch.Tensor, topk_idx: torch.Tensor,
        ...
        Arguments:
            ...
            topk_idx: `torch.Tensor` with `deep_ep_ring.topk_idx_t` (typically `torch.int64`), shaped as `[num_tokens, num_topk]`,
    ...
    def low_latency_combine(self, x: torch.Tensor, topk_idx: torch.Tensor, topk_weights: torch.Tensor,
        ...
        Arguments:
            ...
            topk_idx: `[num_combined_tokens, num_topk]` with `deep_ep_ring.topk_idx_t` (typically `torch.int64`), the expert
